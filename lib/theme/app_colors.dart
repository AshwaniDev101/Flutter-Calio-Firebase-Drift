...
class AppColors {
  ...
  // Calorie Bar Colors (Refined) - Premium Health Palette
  ...
  // Text Colors
  static const Color primaryText = Color(0xFF263238);   // BlueGrey 900
  static const Color secondaryText = Color(0xFF455A64); // BlueGrey 700
  static const Color tertiaryText = Color(0xFF78909C);  // BlueGrey 400
  static const Color hintText = Color(0xFFB0BEC5);      // BlueGrey 200
...
//TODO Remove this and implement proper app text styles
class AppTextStyle {
