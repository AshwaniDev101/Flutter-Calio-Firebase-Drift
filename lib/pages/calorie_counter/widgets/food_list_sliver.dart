...
class _FoodCard extends StatelessWidget {
  ...
  const _FoodCard({super.key, required this.food, required this.barColor, required this.onQuantityChange, required this.editDeleteOptionMenu});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text('${trimTrailingZero(food.foodStats.calories)} kcal', style: AppTextStyle.textStyleCardSubTitle.copyWith(color: Colors.grey[700])),
                        if (food.count > 1)
                          Text(' (total: ${trimTrailingZero(food.foodStats.calories * food.count)})', style: AppTextStyle.textStyleCardSubTitle.copyWith(color: Colors.grey[600])),
                      ],
                    ),
                  ],
                ),
